...
import com.suprema_ai.qfm_sdk_android.debug_message.DebugMessage;
 ...
 * This is modified for the QFM SDK for Android.
 */
public class UsbService extends Service {
    ...
    public boolean connect_check = false;
    ...
    private void findSerialPortDevice() {
        ...
        if (!usbDevices.isEmpty()) {
            ...
            for (Map.Entry<String, UsbDevice> entry : usbDevices.entrySet()) {
                ...
                if (device.getDeviceClass() == 0xEF) {
                    Log.d(TAG, "Not UART device");
                    continue;
                }
...
//                if (deviceVID != 0x1d6b && (devicePID != 0x0001 && devicePID != 0x0002 && devicePID != 0x0003) && deviceVID != 0x5c6 && devicePID != 0x904c) {
    ...
    private void requestUserPermission() {
        ...
        if(android.os.Build.VERSION.SDK_INT >= 31) {
            mPendingIntent = PendingIntent.getBroadcast(context, 0, new Intent(ACTION_USB_PERMISSION), PendingIntent.FLAG_MUTABLE);
        } else {
